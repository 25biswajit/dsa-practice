...
public class EquilibriumIndex {
    ...
    public int findEquilibriumIndex(ArrayList<Integer> A) {
        ...
        {
            leftsum = A.get(i-1);
            rightsum = A.get(A.size()-1) - A.get(i);
            if(leftsum == rightsum){
                return i;
            }
        }
    ...
    private ArrayList<Integer> prefixSum(ArrayList<Integer> list){
