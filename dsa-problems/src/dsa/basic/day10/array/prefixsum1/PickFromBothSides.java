...
public class PickFromBothSides {
    ...
    public void test0(){
        ...
        int[] arr = new int[]{5,12,3,1,2,4};
        Integer result = solveNew2024(arr, 5);
        ...
        result = solveNew2024(arr, 81);
        Assertions.assertEquals(-5453, result);

        arr = new int[]{-533, -666, -500, 169, 724, 478, 358, -38, -536, 705, -855, 281, -173, 961, -509, -5, 942, -173, 436, -609, -396, 902, -847, -708, -618, 421, -284, 718, 895, 447, 726, -229, 538, 869, 912, 667, -701, 35, 894, -297, 811, 322, -667, 673, -336, 141, 711, -747, -132, 547, 644, -338, -243, -963, -141, -277, 741, 529, -222, -684, 35};
        result = solveNew2024(arr, 48);
    ...
    public int solveNew2024(int[] A, int b) {
        int n = A.length;
        int[] pf = new int[n];
        ...
        while(x <= b){
            ...
            backSum = pf[n-1] - pf[n-1-y];
            sum = frontSum + backSum;
